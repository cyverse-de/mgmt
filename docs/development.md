...
Another things to note is the handling of the section. This is needed because the section is placed into each instance of the `ConfigurationValue` generated by the function.
